...
public class Reimburse {
	...
	public Reimburse(int reim_id, String submit_by, Double reim_amt, String reim_type, String reim_descr,
			Date submit_dte2, String reim_recpt, String reim_stat, Date process_dte2, String process_by, int emp_id,
			int type_id, int status_id) {
		...
		this.submit_dte = submit_dte2;
		this.reim_recpt = reim_recpt;
		this.reim_stat = reim_stat;
		this.process_dte = process_dte2;
